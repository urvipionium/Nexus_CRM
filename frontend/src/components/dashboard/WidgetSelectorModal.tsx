...
export default function WidgetSelectorModal({ onAdd }: Props) {
        ...
        <div className="grid grid-cols-2 gap-10">
          ...
          <div className="border rounded-2xl p-6 bg-gray-50">
            ...
            <div className="bg-white shadow rounded-2xl p-6">
              ...
              <h2 className="text-4xl font-bold mt-3">₹4,20,000</h2>
          ...
          <div className="space-y-6">
            ...
            {/* MODULE */}
            <div>
              <label className="block mb-2 font-medium">Module</label>
            ...
            <div className="flex justify-end gap-4 pt-6">
              <button className="border px-5 py-3 rounded-xl">Cancel</button>
